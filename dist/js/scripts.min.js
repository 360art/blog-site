...
},onAfterChange:function(){var a=$(".slick-active").eq(1).data("full"),b=$(".slick-active").not(":eq(1)");b.each(function(){var a=$(this).data("excerpt");$(this).empty().append("<span>"+a+"</span>")}),$(".slick-active").eq(1).empty().append("<span>"+a+"</span>").css("color","white").siblings().css("color","gray")}});$(".opinion__slider").slick({dots:!0,arrows:!1}),$(".news__more").magnificPopup({type:"iframe",tClose:"Zamknij (Esc)",tLoading:"Ładowanie...",iframe:{markup:'<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" frameborder="0" allowfullscreen></iframe></div>'}}),$(".nav__menu").scrollFix()}();